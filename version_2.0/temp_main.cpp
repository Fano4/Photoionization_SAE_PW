...
int photoion_comp(int argc, char* argv[])
{
   ...
   double Pi=acos(-1);
    ...
    string MO_cube_loc("/local/svdwild/svdwild/LiH_pice_0.8/lih_neut_orbital_");
    string dyson_cube_loc("/local/svdwild/svdwild/LiH_pice_0.8/lih_dyson_orbital_");
...
for(int m=0;m!=n_states_neut;m++)
{
   ...
   {
       ss_PICE.str("");
       ss_PICE<<"/local/svdwild/svdwild/LiH_pice_0.8/LiH_PICE_0.8_"<<m<<"_"<<n<<".txt";
       s_PICE=ss_PICE.str();
