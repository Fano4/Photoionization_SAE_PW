...
long double intplushalf_gamma(int n,unsigned long long int* memo); //(Gamma(n+1/2))
double w3j(int l1,int l2,int l3,int m1,int m2,int m3,unsigned long long int* memo);
double wdelta(int a,int b,int c,unsigned long long int* memo);
double wigner3j(int l1,int l2,int l3,int m1,int m2,int m3,unsigned long long int* memo);
