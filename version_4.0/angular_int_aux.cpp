...
//               -ln_factorial(l1-m1,lnfact_memo)-ln_factorial(l2-m2,lnfact_memo)-ln_factorial(l3-m3,lnfact_memo))));
   ...
   for(int l12=fabs(l1-l2);l12!=l1+l2+1;l12++)
   {
      ...
      else
      {
         ...
         //std::cout<<"l12 = "<<l12<<"G12 = "<<G12<<std::endl;
...
//               std::cout<<int(double(l123-m123)/2)<<" => "<<temp<<std::endl;
 ...
 //              std::cout<<l123<<","<<m123<<";"<<(pow(-1,m123)+pow(-1,l123))<<" * "<<pow(2.,m123-2)*m123<<" * "<<gamma_int_or_half(double(l123)/2.)<<"*"<<gamma_int_or_half(double(l123+m123+1)/2.)<<"/ ("<<gamma_int_or_half(double(l123+3)/2.)<<"*"<<temp<<")"<<std::endl;
