...
${icpp} -g -openmp -I/${MKLROOT}/include -I/${MKLROOT}/include/fftw -I/${HF5_ROOT}/include -L/${HF5_ROOT}/lib /${HF5_ROOT}/lib/libhdf5_hl_cpp.a /${HF5_ROOT}/lib/libhdf5_cpp.a /${HF5_ROOT}/lib/libhdf5_hl.a /${HF5_ROOT}/lib/libhdf5.a -L/${MKLROOT}/lib/intel64 -Wl,-rpath -Wl,/${HF5_ROOT}/lib -mkl -liomp5 -lhdf5 -lhdf5_cpp -lpthread -ldl -lrt -lz -DMKL_Complex16="std::complex<double>"  ${DIRECTORY}/photoion_comp.cpp -o ${DIRECTORY}/PWAPIC_an_orth.exe
